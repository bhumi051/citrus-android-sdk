  ...
  <tr align="center">
    ...
    <tr align="left">
	  <td>	
			<br />
	  		// Using Citrus SDK <br /> 
			compile 'com.citrus.sdk:payment-sdk:3.6.1:retrofitoldRelease@aar' <br /> 
		 <br /> 
  ...
  <tr align="center">
    ...
    <tr align="left">
	  <td>	
			<br />
			// Using Citrus SDK <br /> 
			compile 'com.citrus.sdk:payment-sdk:3.6.1:retrofitnewRelease@aar' <br /> 
			// citrus sdk dependencies for retrofit <br /> 
...
### If you are using Google Play Services library in your project and if you are facing multidex problem , update build.gradle as below
	compile ('com.citrus.sdk:payment-sdk:3.6.1:retrofitoldRelease@aar')  {
        transitive = false
    }
    
            OR 
            
    compile ('com.citrus.sdk:payment-sdk:3.6.1:retrofitnewRelease@aar')  {
        transitive = false
    }
