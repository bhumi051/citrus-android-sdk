  ...
  <tr align="center">
    ...
    <tr align="left">
	  <td>	
			<br />
	  		// Using Citrus SDK <br /> 
			compile 'com.citrus.sdk:payment-sdk:3.3.3:retrofitoldRelease@aar' <br /> 
		 <br /> 
  ...
  <tr align="center">
    ...
    <tr align="left">
	  <td>	
			<br />
			// Using Citrus SDK <br /> 
			compile 'com.citrus.sdk:payment-sdk:3.3.3:retrofitnewRelease@aar' <br /> 
			// citrus sdk dependencies for retrofit <br /> 
...
### If you are using Google Play Services library in your project and if you are facing multidex problem , update build.gradle as below
	compile ('com.citrus.sdk:payment-sdk:3.3.3:retrofitoldRelease@aar')  {
        transitive = false
    }
    
            OR 
            
    compile ('com.citrus.sdk:payment-sdk:3.3.3:etrofitnewRelease@aar')  {
        transitive = false
    }
